...
<div class="login-box">
	...
	<div class="login-box-body">
		...
		<div class="row">
			...
			<div class="col-xs-4">
                <?php
                if (Yii::$app->getSession()->hasFlash('noAccess')): ?>
                    <?= Html::submitButton(
                        Yii::$app->session->getFlash('noAccess'),
                        ['class' => 'btn btn-danger  btn-flat', 'name' => 'login-button','disabled'=>1]
